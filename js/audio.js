...
// 后台音乐列表
let musicData = [['洛春赋', '25计科专本2班25216950235朱火勇'], ['Yesterday', '25计科专本2班25216950235朱火勇'], ['江南烟雨色', '25计科专本2班25216950235朱火勇'], ['Vision pt.II', '25计科专本2班25216950235朱火勇']];
...
list.addEventListener('click', function (event) {
    ...
    musicList.style.display = "flex";
    closeList.style.display = "flex";
    closeList.addEventListener('click', closeListBoard); // 绑定关闭事件
});
